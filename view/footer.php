<?php
	switch($global_lang) {
		case EN:
			...
			$second_column = ARRAY("CONTACT","Tel.: (852) 5405 6631","E-mail: luckygrawkt@gmail.com");
		...
		case ZH:
			...
			$second_column = ARRAY("聯絡","電話：(852) 5405 6631","電郵地址：luckygrawkt@gmail.com");
		...
		case CH:
			...
			$second_column = ARRAY("联络","电话：(852) 5405 6631","电邮地址：luckygrawkt@gmail.com");
			$third_column = ARRAY("地址","香港觀塘鴻圖道58號","金凱工業大廈","6樓 25室");
